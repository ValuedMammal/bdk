...
mod test {
    ...
    fn test_spk_cache() {
        ...
        // Expected derived SPKs
        let exp_spks: BTreeMap<u32, ScriptBuf> = (0..end_index + 1)
            .map(|i| {
        ...
        let _ = index.insert_descriptor(0, desc.clone());
        ...
        let index = KeychainTxOutIndex::<&str>::from_changeset(lookahead, false, init_cs);
