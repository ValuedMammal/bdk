...
/// Script pubkey as hex with address `bc1qg35sdfjkpk9dwcxmx9t8qmnju9cl8g42cnry50`
const SPK: &str = "0014446906a6560d8ad760db3156706e72e171f3a2aa";
...
fn create_tx_assets() -> anyhow::Result<()> {
    ...
    let recip = ScriptBuf::from_hex(SPK)?;
